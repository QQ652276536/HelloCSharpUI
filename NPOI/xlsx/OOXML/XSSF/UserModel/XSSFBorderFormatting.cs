    ...
    public class XSSFBorderFormatting : IBorderFormatting
    {
        ...
        public BorderStyle BorderDiagonal
        {
            ...
            set
            {
                ...
                if (value == BorderStyle.None) _border.unsetDiagonal();
        ...
        public BorderStyle BorderLeft
        {
            ...
            set
            {
                ...
                if (value == BorderStyle.None) _border.unsetLeft();
                else pr.style = (ST_BorderStyle)(value);
            }
        }
        ...
        public BorderStyle BorderRight
        {
            ...
            set
            {
                ...
                if (value == BorderStyle.None) _border.unsetRight();
                else pr.style = (ST_BorderStyle)(value );
            }
        }
        ...
        public BorderStyle BorderTop
        {
            ...
            set
            {
                ...
                if (value == BorderStyle.None) _border.unsetTop();
                else pr.style = (ST_BorderStyle)(value );
            }
        }
